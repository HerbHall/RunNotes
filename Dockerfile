...
LABEL org.opencontainers.image.title="RunNotes" \
      ...
      com.docker.extension.detailed-description="RunNotes lets you attach notes to containers so you never forget why a container exists or what you were testing. Features include markdown support with live preview, search by name/content/tags, pin important notes, export/import JSON backup, and orphaned note detection." \
      com.docker.extension.publisher-url="https://github.com/HerbHall" \
      com.docker.extension.additional-urls="[{\"title\":\"Documentation\",\"url\":\"https://github.com/HerbHall/RunNotes#readme\"},{\"title\":\"Report a Bug\",\"url\":\"https://github.com/HerbHall/RunNotes/issues/new\"},{\"title\":\"Support\",\"url\":\"https://github.com/HerbHall/RunNotes/issues\"}]" \
